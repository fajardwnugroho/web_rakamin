...
```{r}
plot_bi_muamalat <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=123180458", range = "cohort-bank-muamalat-bi-analytics")

plot_bi_muamalat$Label = beauty_print(plot_bi_muamalat$Label)

plot_dm_erajaya <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=497909851", range = "cohort-erajaya-dm")

plot_dm_erajaya$Label = beauty_print(plot_dm_erajaya$Label)

plot_ds_idx <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=817098153", range = "cohort-idx-ds")

plot_ds_idx$Label = beauty_print(plot_ds_idx$Label)

plot_be_investree <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=2070693287", range = "cohort-investree-be")

plot_be_investree$Label = beauty_print(plot_be_investree$Label)

plot_fs_investree <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=918789044", range = "cohort-investree-fs")

plot_fs_investree$Label = beauty_print(plot_fs_investree$Label)

plot_cp_jackmall <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=2109982603", range = "cohort-jackmall-cp")

plot_cp_jackmall$Label = beauty_print(plot_cp_jackmall$Label)

plot_bda_kimiafarma <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=811593669", range = "cohort-kimiafarma-bda")

plot_bda_kimiafarma$Label = beauty_print(plot_bda_kimiafarma$Label)

plot_seo_niagahoster <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=929047325", range = "cohort-niagahoster-seo")

plot_seo_niagahoster$Label = beauty_print(plot_seo_niagahoster$Label)

plot_overall <- read_sheet("https://docs.google.com/spreadsheets/d/1bqyWX8JUOFIjQy7Thu_ejN5cSYTcCJUSq-gwNwBKROQ/edit#gid=1177792059", range = "cohort-overall")
...
ggplot(plot_overall) +
  ...
  labs(
    title = "**Weekly User Retention VIX-Overall**",
...
ggplot(plot_bi_muamalat) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-BI Analyst-Bank Muamalat**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_dm_erajaya) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-DM-Erajaya**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_ds_idx) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-DS-ID/X**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_be_investree) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-Backend-Investree**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_fs_investree) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-Fullstack-Investree**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_cp_jackmall) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-Campaign Digital Performance-Jackmall**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_bda_kimiafarma) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-Big Data Analysis-Kimia Farma**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
...
ggplot(plot_seo_niagahoster) +
  ...
  mdthemes::md_theme_gray() +
  labs(
    title = "**Weekly User Retention VIX-SEO-Niagahoster**",
    caption = "*Data: Cohort & user retention (Source: google analytis)*", 
    x = "W-th Weeks",
    y = "Cohort Group"
  )
